$(function(){
	//列出该店铺下所有授权信息的URL
	var listUrl = '/o2oboot/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=999';
	//修改授权信息的Url
	var modifyUrl = '/o2oboot/shopadmin/modifyshopauthmap';
	...
	$('.shopauth-wrap').on('click', 'a', function(e){
		...
		if (target.hasClass('edit')){
			window.location.href = '/o2oboot/shopadmin/shopauthedit?shopAuthId=' + e.currentTarget.dataset.authId;
