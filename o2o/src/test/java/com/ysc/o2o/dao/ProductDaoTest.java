...
/*		ProductImg productImg1 = new ProductImg();
		...
		for (ProductImg img : product.getProductImgList()) {
			System.out.println(img.getImgAddr());
			System.out.println(img.getImgDesc());
			System.out.println(img.getPriority());
		}
