package com.ysc.o2o.util.wechat;
...
public class WechatUserUtil {
	...
	public static WechatUser getUserInfo(String accessToken, String openId) {
		//根据传入的accessToken以及openId拼接出访问微信定义的端口并获取用户信息URL
	...
	private static String httpsRequest(String requestUrl, String requestMethod, String outputStr) {
		...
		try {
			...
			InputStreamReader inputStreamReader = new InputStreamReader(inputStream, "uft-8");
