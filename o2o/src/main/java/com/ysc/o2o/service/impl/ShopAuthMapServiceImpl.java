...
import com.ysc.o2o.enums.ShopAuthMapStateEnum;
import com.ysc.o2o.exceptions.ShopAuthMapOperationException;
	...
	public ShopAuthMapExecution modifyShopAuthMap(ShopAuthMap shopAuthMap) throws ShopAuthMapOperationException {
		...
		if (shopAuthMap == null || shopAuthMap.getShopAuthId() == null) {
			...
			try {
				...
				throw new ShopAuthMapOperationException("modifyShopAuthMap err: " + e.toString());
			}
		}
	}
