...
import com.ysc.o2o.exceptions.LocalAuthOperationException;
import com.ysc.o2o.service.LocalAuthService;
import com.ysc.o2o.util.CodeUtil;
import com.ysc.o2o.util.HttpServletRequestUtil;
import com.ysc.o2o.util.MD5;
...
public class LocalAuthController {
	...
	private Map<String, Object> changeLocalPwd(HttpServletRequest request) {
		...
		//从session中获取当前用户信息（用户一旦登录微信之后，便能获取到用哦过户的信息）
		PersonInfo user = (PersonInfo) request.getSession().getAttribute("user");
		//非空判断，要求帐号新旧密码以及当前的用户session为非空，且新旧密码不想同
		if (userName != null && password != null && newPassword != null && user.getUserId() != null
				&& !password.equals(newPassword)) {
			try {
				//查看原先帐号，看看与输入的账号是否一致，不一致则认为是非法操作
